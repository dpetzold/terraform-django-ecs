...
- [otp: One Time Password utilities Go / Golang](#otp-one-time-password-utilities-go--golang)
- [Why One Time Passwords?](#why-one-time-passwords)
  - [`otp` Supports:](#otp-supports)
  - [Implementing TOTP in your application:](#implementing-totp-in-your-application)
    - [User Enrollment](#user-enrollment)
    - [Code Generation](#code-generation)
    - [Validation](#validation)
    - [Recovery Codes](#recovery-codes)
  - [Improvements, bugs, adding feature, etc:](#improvements-bugs-adding-feature-etc)
  - [License](#license)
